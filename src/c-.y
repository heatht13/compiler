...
fullIterStmt     : WHILE simpleExp DO full
			...
			{
                          /*$$ = newStmtNode(ForK, $1);
                          $$->child[0] = newExpNode(AssignK, $3);
                          $$->child[0]->child[0] = newDeclNode(VarK, $2);
                          $$->child[0]->child[0]->expType = Integer;
                          $$->child[0]->child[0]->type = strdup((char *)"int");
                          $$->child[0]->child[1] = $4;
                          $$->child[1] = $4;*/

                          //NEED TO CHANGE SEMANTICS IF ABOVE STAYS
